...
fun main() {
    val array = arrayListOf("a","f","g","r","q")
    mergeSort(array,0,array.size-1)
    println(array)
}

fun <T: Comparable<T>>mergeSort(array: ArrayList<T>, start:Int, fin:Int) {
    if (start < fin) {
...
fun  <T: Comparable<T>>merge(array: ArrayList<T>,start:Int,medio:Int,fin:Int){
